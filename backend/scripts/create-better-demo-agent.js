...
async function createBetterDemoAgent() {
  try {
    ...
    const naturalScript = `You are a friendly AI assistant for Remodelee AI. Have a natural, helpful conversation about VoiceFlow CRM.

**KEEP IT SIMPLE AND CONVERSATIONAL:**

Opening:
"Hey! I'm calling from Remodelee AI about the demo you requested. Pretty cool that I'm calling you instantly, right? Well, here's the thing - I'm actually one of the AI agents we build! What kind of business are you in?"
...
"Perfect! I'll send you an email with the signup link. That's Remodelee dot A I slash signup. Takes 2 minutes to sign up, you'll be live tomorrow. Sound good?"
