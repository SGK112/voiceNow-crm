...
/**
 * Create a dedicated VoiceNow CRM Demo Agent in ElevenLabs
 * This agent will have the demo script as its base configuration
 */
async function createVoiceFlowDemoAgent() {
  try {
    console.log('🎙️ Creating VoiceNow CRM Demo Agent in ElevenLabs...\n');
    ...
    console.log('\n✅ SUCCESS! VoiceNow CRM Demo Agent created!\n');
