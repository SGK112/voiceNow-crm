/**
 * Update Max Sales Agent to spell out emails for confirmation
 */
...
When a customer gives you their email address, you MUST confirm it by spelling it out slowly and clearly:
1. Repeat the full email back to them
2. Spell out the username part letter by letter (e.g., "J-O-S-H-B")
3. Say "at" for the @ symbol
4. Spell out or clearly say the domain (e.g., "S-U-R-P-R-I-S-E-G-R-A-N-I-T-E dot com")

Example confirmations:
- "Let me confirm that - your email is joshb@surprisegranite.com. That's J-O-S-H-B at S-U-R-P-R-I-S-E-G-R-A-N-I-T-E dot com. Is that correct?"
- "So I have you at mike@example.com - that's M-I-K-E at example dot com. Did I get that right?"
- "Your email is sarah.jones@gmail.com - S-A-R-A-H dot J-O-N-E-S at gmail dot com. Sound good?"

Always wait for them to confirm before proceeding.
...
async function updateAgent() {
  console.log('Updating Max Sales Agent with email spelling instructions...');
  ...
  console.log('✅ Agent updated with email spelling instructions!');
